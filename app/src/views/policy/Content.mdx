## Privacy Policy of www.signsafe.no
...
Data collected from the user when using the applicaton will not be disributed to any third party.
...
Owner contact email: info@signsafe.no
...
The data collected from the applicaton will only be available when a user has been confirmed with Covid-19. Data will then be avalible to owner in order to send out alerts of possible Covid-19 infection to users.
...
Personal data will not be stored for longer than 10 days.
...
Once the retention period expires, Personal Data shall be deleted. Therefore, the right to access, the right to erasure, the right to rectification and the right to data portability cannot be enforced.

#### The purposes of processing

The Data concerning the User is collected to allow the Owner to provide its Service, comply with its legal obligations, respond to enforcement requests, protect its rights and interests (or those of its Users or third parties), confirmed Covid-19 infection of one or more users, detect any malicious or fraudulent activity, as well as the following: Hosting and backend infrastructure.
